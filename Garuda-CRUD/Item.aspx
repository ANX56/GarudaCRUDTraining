<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Item.aspx.cs" Inherits="Garuda_CRUD.WebForm1" %>
...
<body style="width: 1132px; height: 542px;">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td class="auto-style2">&nbsp;</td>
			<td class="auto-style5">
				<asp:RadioButtonList ID="Grid_Sort" runat="server" Height="36px" RepeatDirection="Horizontal" Width="268px" OnSelectedIndexChanged="Grid_Sort_SelectedIndexChanged">
...
&nbsp;&nbsp;
			...
			<asp:GridView ID="Grid1" runat="server" AutoGenerateColumns="False" CellPadding="3" HorizontalAlign="Center" Width="100%" style="margin-bottom: 0px" OnRowCommand="Grid1_RowCommand" OnRowDataBound="Grid1_DataBound" OnRowDeleting="Grid1_RowDeleting" OnRowEditing="Grid1_RowEditing">
							<Columns>
